 ...
 void PrintUsage(const char* program_name) {
     ...
     std::cout << "  " << program_name 
              << " <breached_dem> <flow_dirs> <accumulation> <output_prefix> <pourpoints_file> <stream_threshold>"
              << std::endl;
     
     std::cout << "\nArguments:" << std::endl;
     std::cout << "  breached_dem     Path to breached DEM file (from carve command)" << std::endl;
     std::cout << "  flow_dirs        Path to ESRI flow directions file (for example *_DIR.tif)" << std::endl;
     std::cout << "  accumulation     Path to flow accumulation file (for example *_FAC.tif)" << std::endl;
     ...
     std::cout << "  " << program_name 
              << " run1_DEM_breached.tif run1_DIR.tif run1_FAC.tif output pourpoints.txt 10000"
              << std::endl;
 ...
 int main(int argc, char** argv) {
     ...
     std::string breached_dem = argv[1];
     ...
     std::cout << "  Breached DEM:     " << breached_dem << std::endl;
